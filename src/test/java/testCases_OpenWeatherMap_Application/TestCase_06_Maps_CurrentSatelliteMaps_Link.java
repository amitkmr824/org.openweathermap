...
public class TestCase_06_Maps_CurrentSatelliteMaps_Link extends BaseTestReport{
	...
	@Test
	public void test_Maps_CurrentSatelliteLink()
	{
		test = extent.createTest("Verify by clicking on Satellite Maps Link, it should open in new Tab successfully");
		...
		maps.click_Maps();
		maps.click_Current_SateliteMaps();
