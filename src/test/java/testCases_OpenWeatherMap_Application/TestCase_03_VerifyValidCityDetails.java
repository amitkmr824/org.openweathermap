...
public class TestCase_03_VerifyValidCityDetails extends BaseTestReport{
	
	ExtentReports report;
	ExtentTest logger;
	
	@Test
	public void test_VerifyValidCity_Details()
	{
		test = extent.createTest("Verify Weather details displayed on enerting Valid City in the search text");
		...
		searchcity.validCitySearch_Functionality();
	}	
